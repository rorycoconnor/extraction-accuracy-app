      ...
      <div className="px-4 md:px-8 flex justify-between h-[72px] py-3">
        ...
        <div className="flex items-center gap-4 text-xs mr-9">
          ...
          <div className="flex items-center gap-1">
            <div className="w-4 h-4 bg-green-100 dark:bg-green-900/55 border border-green-200 dark:border-green-400 rounded-sm"></div>
            <span className="text-foreground">Match</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-4 h-4 bg-yellow-100 dark:bg-yellow-900/55 border border-yellow-200 dark:border-yellow-400 rounded-sm"></div>
            <span className="text-foreground">Different Format</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-4 h-4 bg-blue-100 dark:bg-blue-900/55 border border-blue-200 dark:border-blue-400 rounded-sm"></div>
            <span className="text-foreground">Partial Match</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-4 h-4 bg-red-100 dark:bg-red-900/55 border border-red-200 dark:border-red-400 rounded-sm"></div>
